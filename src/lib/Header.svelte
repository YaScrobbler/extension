...
<div class="navbar bg-base-100 shadow-sm mb-2 top-0 sticky">
  <div class="flex-1">
    <a href="http://vk.com" class="btn btn-ghost text-xl">YaScrobbler</a>
  </div>
  <div class="flex-none">
    <button class="btn btn-square btn-ghost" aria-label="more">
